...
{
	/**
	 * Convert an integer to a IPV4 <code>iIPV4</code>'s highest byte represents
	 * the first ip seg
	 */
	...
	/**
	 * Convert a String IPV4 to an integer <code>strIPV4</code>'s first seg is
	 * the highest byte of the returned integer
	 */
